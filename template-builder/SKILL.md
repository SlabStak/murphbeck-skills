...
- [agent-templates.md](agent-templates.md) - Agent definitions (core agents)
- [agent-templates-extended.md](agent-templates-extended.md) - Extended agents (security, testing, docs, deploy)
...
- [ci-templates.md](ci-templates.md) - GitHub Actions, GitLab CI, Bitbucket Pipelines
- [docker-templates.md](docker-templates.md) - Dockerfiles, docker-compose configs
- [env-templates.md](env-templates.md) - Environment variables & secrets management
- [test-templates.md](test-templates.md) - Vitest, Playwright, Jest, pytest configs
...
- [python-fastapi.md](scaffolds/python-fastapi.md) - Python FastAPI backend
- [chrome-extension.md](scaffolds/chrome-extension.md) - Chrome Extension MV3

### System Architecture
- [wizard-system.md](wizard-system.md) - Interactive wizard implementation
- [template-variables.md](template-variables.md) - Variable substitution system
- [project-detection.md](project-detection.md) - Auto-detect project type
...
Types: `nextjs-saas`, `expo-mobile`, `fastify-api`, `monorepo`, `python-fastapi`, `chrome-extension`

Example:
```
/template-builder scaffold nextjs-saas my-app
/template-builder scaffold python-fastapi my-api
/template-builder scaffold chrome-extension my-extension
```
...
### Core Agents (agent-templates.md)
- **build-validator** - Runs build, typecheck, lint, tests before commits
- **code-simplifier** - Reduces complexity and removes dead code
- **code-architect** - Designs system architecture
- **verify-app** - End-to-end application verification

### Extended Agents (agent-templates-extended.md)
- **security-auditor** - Scans for secrets, SQL injection, XSS, vulnerable deps
- **performance-profiler** - Bundle analysis, React perf, N+1 queries, memory leaks
- **migration-assistant** - Framework upgrades with breaking change detection
- **documentation-writer** - API docs, README, OpenAPI spec generation
- **test-generator** - Generates unit, integration, E2E tests
- **deploy-validator** - Pre-deploy checks, health endpoints, security headers
- **api-tester** - CRUD testing, auth flows, performance benchmarks
- **database-migrator** - Safe migrations, rollback procedures, data verification
